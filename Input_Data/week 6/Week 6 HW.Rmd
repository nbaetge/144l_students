...
Phyloseq takes input from bioinformatic pipelines and supports calculations (ie alpha/beta diversity) and create cool plots (phylogenetic tables, ordinartions,etc).
...
sample.tab <- read_rds("~/Github/144l_students/Input_Data/week4/144L_Processed_DOC_BGE.rds") %>% 
